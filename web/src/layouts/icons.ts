...
export const ICONS: Record<string, string> = {
    ...
    'signpost': '<svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M9 2.25v13.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M9 4.5h5.25l1.5 2.25-1.5 2.25H9M9 10.5H3.75L2.25 12.75l1.5 2.25H9" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg>',
